    ...
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="widget-body">
                ...
                {{ Form::open(array(
                    'url' => URL::to('/admin/lab/edit/'.$lab->id),
                    ...
                    <div class="content-form">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $lab->name }}">
                            </div>
                            <div class="col-md-6 form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="phone" class="form-control"  value="{{ $lab->phone }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>Vĩ độ <span class="required"> *</span></label>
                                <input type="text" name="lat" class="form-control"  value="{{ $lab->lat }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>Kinh độ <span class="required"> *</span></label>
                                <input type="text" name="long" class="form-control"  value="{{ $lab->long }}">
                            </div>
                        </div>
                    </div>
