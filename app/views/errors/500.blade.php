...
<html>
    ...
    <body>
        <div class="wrap">
            <div class="header">
                <div class="logo">
                    <h1><a href="#">Có lỗi trong quá trình xử lý</a></h1>
                </div>
            </div>
            <div class="content">
                <img src="{{Asset('assets/img/error-500.png')}}" title="error">
                <p><span>Ohh.....</span>Có lỗi trong quá trình xử lý, vui lòng thông báo tới quản trị website.</p>
